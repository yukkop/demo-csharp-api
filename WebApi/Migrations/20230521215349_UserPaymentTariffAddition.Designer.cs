...
namespace WebApi.Migrations
{
    ...
    [Migration("20230521215349_UserPaymentTariffAddition")]
    partial class UserPaymentTariffAddition
    {
            ...
            modelBuilder.Entity("Logic.Database.Models.PeriodUnit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5693),
                            Unit = "day",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5695)
                        },
                        new
                        {
                            Id = new Guid("9ebbb82c-27ef-4a25-a93e-524d61b0a4d7"),
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5706),
                            Unit = "month",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5709)
                        },
                        new
                        {
                            Id = new Guid("15266afb-5997-43ee-93a5-15e6a5b394bf"),
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5717),
                            Unit = "year",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5719)
                        });
                });
            ...
            modelBuilder.Entity("Logic.Database.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "4cb6910c-97ea-43c2-bb5b-a721d7ccb9c3",
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5544),
                            Name = "Super",
                            NormalizedName = "SUPER",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5546)
                        },
                        new
                        {
                            Id = new Guid("fac6a18c-14b6-4427-981b-7bbaaa77b7c6"),
                            ConcurrencyStamp = "de3b55cc-4873-4825-acf0-55af96af8755",
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5599),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5602)
                        },
                        new
                        {
                            Id = new Guid("f176c034-6c6c-4f7f-8841-2bd5b05a702a"),
                            ConcurrencyStamp = "6d1ed60c-a053-49aa-a6d1-8457509c1d5e",
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5615),
                            Name = "VpnUser",
                            NormalizedName = "VPNUSER",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5618)
                        },
                        new
                        {
                            Id = new Guid("9e479955-2de9-4a9d-b922-bbea18871593"),
                            ConcurrencyStamp = "bb1c1ddd-f495-4eec-98ff-9b4d04471ec3",
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5631),
                            Name = "BotSystem",
                            NormalizedName = "BOTSYSTEM",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5633)
                        },
                        new
                        {
                            Id = new Guid("1d939b37-0430-49b3-a3ab-ae83913e3745"),
                            ConcurrencyStamp = "8784584c-a6dc-4727-a669-dcdc1002b5c3",
                            CreatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5645),
                            Name = "Employer",
                            NormalizedName = "EMPLOYER",
                            UpdatedAt = new DateTime(2023, 5, 21, 23, 53, 48, 843, DateTimeKind.Local).AddTicks(5647)
                        });
                });

...
namespace WebApi.Migrations
{
    ...
    [Migration("20230508030227_AddNewRolesAndFixSuperUser")]
    partial class AddNewRolesAndFixSuperUser
    {
            ...
            modelBuilder.Entity("Logic.Database.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "55d6bf9b-16bc-4117-8f3f-6b3210d2d0b4",
                            CreatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7074),
                            Name = "Super",
                            NormalizedName = "SUPER",
                            UpdatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7077)
                        },
                        new
                        {
                            Id = new Guid("fac6a18c-14b6-4427-981b-7bbaaa77b7c6"),
                            ConcurrencyStamp = "4aee683f-2929-4a9a-aa07-b806a84e9563",
                            CreatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7300),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7303)
                        },
                        new
                        {
                            Id = new Guid("f176c034-6c6c-4f7f-8841-2bd5b05a702a"),
                            ConcurrencyStamp = "23e53817-0a9a-4d6c-a413-5b122a2b4e43",
                            CreatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7339),
                            Name = "VpnUser",
                            NormalizedName = "VPNUSER",
                            UpdatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7342)
                        },
                        new
                        {
                            Id = new Guid("9e479955-2de9-4a9d-b922-bbea18871593"),
                            ConcurrencyStamp = "eea7e623-4b91-48ed-b2ce-0b735658e7a6",
                            CreatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7375),
                            Name = "BotSystem",
                            NormalizedName = "BOTSYSTEM",
                            UpdatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7378)
                        },
                        new
                        {
                            Id = new Guid("1d939b37-0430-49b3-a3ab-ae83913e3745"),
                            ConcurrencyStamp = "707d5a8d-a5cc-4644-93a1-12e5ce1bb229",
                            CreatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7412),
                            Name = "Employer",
                            NormalizedName = "EMPLOYER",
                            UpdatedAt = new DateTime(2023, 5, 8, 5, 2, 27, 17, DateTimeKind.Local).AddTicks(7415)
                        });
                });

...
namespace WebApi.Migrations
{
    ...
    [Migration("20230517011858_TariffImpliment")]
    partial class TariffImpliment
    {
            ...
            modelBuilder.Entity("Logic.Database.Models.PeriodUnit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(828),
                            Unit = "day",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(832)
                        },
                        new
                        {
                            Id = new Guid("9ebbb82c-27ef-4a25-a93e-524d61b0a4d7"),
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(849),
                            Unit = "month",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(853)
                        },
                        new
                        {
                            Id = new Guid("15266afb-5997-43ee-93a5-15e6a5b394bf"),
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(867),
                            Unit = "year",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(871)
                        });
                });
            ...
            modelBuilder.Entity("Logic.Database.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "7582171f-aba6-494a-8041-b7fd73400606",
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(587),
                            Name = "Super",
                            NormalizedName = "SUPER",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(591)
                        },
                        new
                        {
                            Id = new Guid("fac6a18c-14b6-4427-981b-7bbaaa77b7c6"),
                            ConcurrencyStamp = "3fd0e858-7863-4c69-a6fb-46d31ea35394",
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(670),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(674)
                        },
                        new
                        {
                            Id = new Guid("f176c034-6c6c-4f7f-8841-2bd5b05a702a"),
                            ConcurrencyStamp = "f1470b22-c0b0-4bca-9205-e2b002fd3538",
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(698),
                            Name = "VpnUser",
                            NormalizedName = "VPNUSER",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(702)
                        },
                        new
                        {
                            Id = new Guid("9e479955-2de9-4a9d-b922-bbea18871593"),
                            ConcurrencyStamp = "ca850c90-bc83-4bf8-a90d-ab20e8becec2",
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(723),
                            Name = "BotSystem",
                            NormalizedName = "BOTSYSTEM",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(727)
                        },
                        new
                        {
                            Id = new Guid("1d939b37-0430-49b3-a3ab-ae83913e3745"),
                            ConcurrencyStamp = "5b09c1c8-cd23-4b49-abc0-dce842be981e",
                            CreatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(747),
                            Name = "Employer",
                            NormalizedName = "EMPLOYER",
                            UpdatedAt = new DateTime(2023, 5, 17, 3, 18, 57, 375, DateTimeKind.Local).AddTicks(750)
                        });
                });

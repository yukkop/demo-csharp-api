...
namespace WebApi.Migrations
{
    ...
    [Migration("20230613133417_AddIntegrationColumnToPaymentsTable")]
    partial class AddIntegrationColumnToPaymentsTable
    {
            ...
            modelBuilder.Entity("Logic.Database.Models.PeriodUnit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7231),
                            Unit = "day",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7245)
                        },
                        new
                        {
                            Id = new Guid("9ebbb82c-27ef-4a25-a93e-524d61b0a4d7"),
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7264),
                            Unit = "month",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7279)
                        },
                        new
                        {
                            Id = new Guid("15266afb-5997-43ee-93a5-15e6a5b394bf"),
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7293),
                            Unit = "year",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7302)
                        });
                });
            ...
            modelBuilder.Entity("Logic.Database.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "c1c3c108-14af-4c1c-86fe-2d01d6e062ad",
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(6930),
                            Name = "Super",
                            NormalizedName = "SUPER",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(6944)
                        },
                        new
                        {
                            Id = new Guid("fac6a18c-14b6-4427-981b-7bbaaa77b7c6"),
                            ConcurrencyStamp = "44fc9b8e-e6c6-40e6-a865-275eec2db1fa",
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7034),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7048)
                        },
                        new
                        {
                            Id = new Guid("f176c034-6c6c-4f7f-8841-2bd5b05a702a"),
                            ConcurrencyStamp = "1808e335-ea7f-45d8-b67b-04db3182ea65",
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7072),
                            Name = "VpnUser",
                            NormalizedName = "VPNUSER",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7087)
                        },
                        new
                        {
                            Id = new Guid("9e479955-2de9-4a9d-b922-bbea18871593"),
                            ConcurrencyStamp = "714ade51-f0e7-4a39-bae4-3653581dde72",
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7115),
                            Name = "BotSystem",
                            NormalizedName = "BOTSYSTEM",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7124)
                        },
                        new
                        {
                            Id = new Guid("1d939b37-0430-49b3-a3ab-ae83913e3745"),
                            ConcurrencyStamp = "71aee161-0db1-4999-9422-60aeb586251a",
                            CreatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7153),
                            Name = "Employer",
                            NormalizedName = "EMPLOYER",
                            UpdatedAt = new DateTime(2023, 6, 13, 15, 34, 17, 248, DateTimeKind.Local).AddTicks(7168)
                        });
                });

...
namespace WebApi.Migrations
{
    ...
    [Migration("20230510111204_EmployerTables")]
    partial class EmployerTables
    {
            ...
            modelBuilder.Entity("Logic.Database.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "68cb6fde-24ee-4f03-ba6c-c4a404d8f613",
                            CreatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(4909),
                            Name = "Super",
                            NormalizedName = "SUPER",
                            UpdatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(4912)
                        },
                        new
                        {
                            Id = new Guid("fac6a18c-14b6-4427-981b-7bbaaa77b7c6"),
                            ConcurrencyStamp = "99a86bcb-bfcf-4efb-b43d-b10772634446",
                            CreatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5035),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            UpdatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5037)
                        },
                        new
                        {
                            Id = new Guid("f176c034-6c6c-4f7f-8841-2bd5b05a702a"),
                            ConcurrencyStamp = "b5b762fa-d980-474d-8860-5b918e90f84b",
                            CreatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5069),
                            Name = "VpnUser",
                            NormalizedName = "VPNUSER",
                            UpdatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5072)
                        },
                        new
                        {
                            Id = new Guid("9e479955-2de9-4a9d-b922-bbea18871593"),
                            ConcurrencyStamp = "04f60601-bba7-45ef-812c-9c92a2736fd0",
                            CreatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5100),
                            Name = "BotSystem",
                            NormalizedName = "BOTSYSTEM",
                            UpdatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5103)
                        },
                        new
                        {
                            Id = new Guid("1d939b37-0430-49b3-a3ab-ae83913e3745"),
                            ConcurrencyStamp = "b5818645-b104-434e-885e-ab44ad5bcadc",
                            CreatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5132),
                            Name = "Employer",
                            NormalizedName = "EMPLOYER",
                            UpdatedAt = new DateTime(2023, 5, 10, 13, 12, 4, 209, DateTimeKind.Local).AddTicks(5135)
                        });
                });
